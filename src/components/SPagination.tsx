 ...
 return (
  <button
   ...
   className={[
    ...
    active ? 'bg-Blue_B_Lighten-1 text-white hover:!text-white' : `text-Grey_Darken-2 ${typeof children === 'number' && 'hover:text-Blue_B_Lighten-1'}`,
    className,
...
const SPagination = ({
 ...
 const iconClass = 'inline-flex items-center justify-center gap-x-8pxr';
 return (
  <div
   className={[
  ...
  >
   {pagination.perPage !== 1 && pagination.page !== 1 && (
